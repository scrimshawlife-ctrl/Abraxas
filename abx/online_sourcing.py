...
def route_online_sources(
    *,
    ...
    - if online is not allowed: block by policy
    ...
    if not online_allowed:
        return {
            ...
            "reason_code": "online_policy_blocked",
        }
