...
def main() -> None:
    ...
    parser.add_argument("--out", default="out/canary/observation_ledger.latest.json")
    args = parser.parse_args()

    execution_run = _read(args.execution)
    previous = _read(args.previous) if args.previous else None
    report = run_observation_ledger(execution_run, previous)
