...
def main() -> None:
    ...
    parser.add_argument("--decision", default="out/reports/pse_calibration_activation_decision.latest.json")
    parser.add_argument("--out", default="out/reports/pse_calibration_candidate_cycle.latest.json")
    ...
    decision = json.loads((REPO_ROOT / args.decision).read_text(encoding="utf-8"))
